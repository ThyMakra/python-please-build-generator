from .global_variables import (
    PYTHON_LIBRARY_FORMAT_WITH_DEPENDENCIES,
    PYTHON_LIBRARY_FORMAT_WITHOUT_DEPENDENCIES,
)
...
def get_pip_library_string(dependencies, package_name, package_version):
    ...
    if len(dependencies) != 0:
        ...
        pip_library_string = PYTHON_LIBRARY_FORMAT_WITH_DEPENDENCIES.format(
            package_name, package_version, dependencies_format
        )
    else:
        pip_library_string = PYTHON_LIBRARY_FORMAT_WITHOUT_DEPENDENCIES.format(
